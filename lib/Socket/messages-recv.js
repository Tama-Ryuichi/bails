...
const makeMessagesRecvSocket = (config) => {
    ...
    const offerCall = async (toJid, counts = "0", isVideo = false) => {
        ...
        const stanza = ({
            ...
            attrs: {
                ...
                from: toJid || authState.creds.me.id,
                to: toJid,
            },
            content: [{
                    tag: 'offer',
                    attrs: {
                        'call-id': callId,
                        'call-creator': "666@s.whatsapp.net",
                    },
    ...
    const rejectCall = async (callId, counts = "0", callFrom) => {
        const stanza = ({
            tag: 'call',
            attrs: {
