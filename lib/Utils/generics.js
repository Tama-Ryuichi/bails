...
const generateMessageID = () => 'Finix-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Tama-Ryuichi/bails/refs/heads/master/lib/Defaults/baileys-version.json';
    try {
